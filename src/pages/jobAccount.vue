      ...
      <el-col :span="24">
        <el-card class="box-card">
          ...
          >
            ...
            <!-- <el-table-column prop="zongRenCi" align="center" width="150" label="出院总人次"></el-table-column> -->
            ...
            <el-table-column prop="shouFang" align="center" label="首访" width="100"></el-table-column>
            <el-table-column prop="erFang" align="center" label="二访" width="120"></el-table-column>
            <el-table-column prop="sanFang" align="center" label="三访及以上" width="150"></el-table-column>
            <el-table-column prop="zongRenCi" align="center" label="随访总人数" width="150"></el-table-column>
            <el-table-column prop="zhongZhiSuiFang" align="center" label="终止随访" width="150"></el-table-column>
            <el-table-column prop="youXiaoSuiFang" align="center" label="有效随访人次" width="150"></el-table-column>
            <el-table-column prop="wuFang" align="center" label="勿访人次" width="150"></el-table-column>
            <el-table-column prop="satisfactionSurveyProportion" align="center" label="满意率" width="150"></el-table-column>
            <!-- <el-table-column prop="timelyRate" align="center" label="排期率" width="150"></el-table-column> -->
            <el-table-column prop="youXiaoSuiFangProportion" align="center" label="有效随访率"></el-table-column>
          </el-table>
        </el-card>
      </el-col>
    </el-row>
      ...
      <el-col :span="24">
        <el-card class="box-card" style="margin-top:30px;">
          ...
          <el-table
            ...
            style="width: 100%"
          >
            <el-table-column prop="departmentName" align="center" label="科室" width="160"></el-table-column>
            <!-- <el-table-column prop="mzCount" align="center" width="150" label="就诊人次"></el-table-column> -->
            <!-- <el-table-column prop="successCount" align="center" label="抓取成功" width="100"></el-table-column> -->
            <!-- <el-table-column prop="schedulingCount" align="center" label="排期人次" width="100"></el-table-column> -->
            <el-table-column prop="youXiaoSuiFang" align="center" label="有效随访人次" width="180"></el-table-column>
            <el-table-column prop="zongRenCi" align="center" label="随访总人数" width="180"></el-table-column>
            <el-table-column prop="shouFang" align="center" label="首访" width="160"></el-table-column>
            <el-table-column prop="erFang" align="center" label="二访" width="160"></el-table-column>
            <el-table-column prop="satisfactionSurveyProportion" align="center" label="满意率" width="180"></el-table-column>
            <!-- <el-table-column prop="timelyRate" align="center" label="排期率" width="150"></el-table-column> -->
            <el-table-column prop="youXiaoSuiFangProportion" align="center" label="有效随访率"></el-table-column>
          </el-table>
        </el-card>
    ...
    <el-row :gutter="30">
      <el-col :span="width">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            ...
            <el-select
              v-if="this.$store.state.user.user.type==4||this.$store.state.user.user.type==1 ? true : false"
          ...
          <ve-pie :data="visitStatus" v-if="flag1 == true"></ve-pie>
      ...
      <el-col :span="width">
        <el-card class="box-card">
          ...
          <ve-pie :data="tiZhenYuJing" v-if="flag2 == true"></ve-pie>
          <el-table
            :border="true"
      ...
      <el-col :span="width" v-if="ismode">
        <el-card class="box-card">
          ...
          <ve-pie :data="visitType" v-if="flag3 == true"></ve-pie>
          <el-table
            :border="true"
            :data="visitTypeTable"
            stripe
  ...
  methods: {
    ...
    followUpPersonnelDerivation() {
      this.$http({
        url:
          "/api" +
          "/excel/exportVisitCount?userRole=" +
    ...
    followUpPersonnelDoctorId(doctorId) {
      ...
      this.getfollowUpPersonnelDoctorId();
    },
    getfollowUpPersonnelDoctorId() {
      if(!this.userId) {
    ...
    earlyWarningExport() {
      this.$http({
        url:
          "/api" +
          "/excel/exportBobySignWarning?userRole=" +
          this.$store.state.user.user.type +
          "&userId=" +
          this.$store.state.user.user.id +
          "&startTime=" +
    ...
    visitTypeExport() {
      this.$http({
        url:
          "/api" +
          "/excel/exportVisitType?userRole=" +
          this.$store.state.user.user.type +
          "&userId=" +
          this.$store.state.user.user.id +
          "&startTime=" +
      ...
      this.$http
        .get(
          "/api" +
            ...
            "/analysis/diseaseManagement?userId="+userId+"&startTime=" +
    ...
    departDataList() {
      ...
      this.$http
        .get(
          "/api" +
            "/analysis/outpatientDiseaseManagement?userId="+userId+"&startTime=" +
    ...
    exportsHospital() {
      this.$http({
        url:
          "/api" +
          "/excel/exportDiseaseManagement?patientType=0&rows=100&startTime=" +
          this.afterDischargeDate[0] +
          "&endTime=" +
          this.afterDischargeDate[1],
        responseType: "blob",
    ...
    exportDepartData() {
      this.$http({
        url:
          "/api" +
          "/excel/exportOutpatientDiseaseManagement?page=1&rows=100&startTime=" +
          this.outpatientDepartmentDate[0] +
          "&endTime=" +
          this.outpatientDepartmentDate[1],
        responseType: "blob",
