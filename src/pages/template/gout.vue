  ...
  <div>
    ...
    <el-form ref="form" :model="form" label-width="135px" class="createVisit_form">
      ...
      <el-row :gutter="80">
        ...
        <el-col :span="8" v-show="ispositionName">
          <el-form-item label="请选择痛风部位 : ">
            <el-select v-model="form.visitRecordContent.positionName" multiple placeholder="请选择">
              <el-option
                v-for="item in sfpositionName"
                :key="item.value"
                :label="item.label"
                :value="item.value"
              ></el-option>
      ...
      <el-row :gutter="0">
        <el-col :span="8">
          <el-form-item label="是否有并发症状 : ">
            <el-select
              ...
              @change="complicationChange($event,7)"
              placeholder="请选择"
            >
              <el-option
        ...
        <el-col :span="8" v-show="iscomplication">
          <el-form-item label="并发症 : ">
            <el-select v-model="form.visitRecordContent.bfzClassify" @change="bfzChange($event,7)">
              <el-option
                v-for="item in sfbfz"
                :key="item.value"
                :value="item.value"
