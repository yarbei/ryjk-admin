<template>
  <div>
    ...
    <el-form ref="form" :model="form" label-width="135px" class="createVisit_form">
      ...
      <el-row :gutter="80" v-for="(dosage, index) in  form.dosages" :key="dosage.key">
        <el-col :span="6">
          <el-form-item label="药物名称" :prop="'dosages.' + index + '.value'">
