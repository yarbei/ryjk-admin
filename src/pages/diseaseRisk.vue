<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="lungs" align="center" label="肺部疾病占比"></el-table-column>
      <el-table-column prop="colorectalTotal" align="center" label="结直肠类疾病人次"></el-table-column>
      <el-table-column prop="colorectal" align="center" label="结直肠类疾病占比"></el-table-column>
      <el-table-column prop="upperGastrointestinalTractTotal" align="center" label="上消化道疾病人次"></el-table-column>
      <el-table-column prop="upperGastrointestinalTract" align="center" label="上消化道疾病占比"></el-table-column>
      <el-table-column prop="cerebralApoplexyTotal1" align="center" label="脑卒中疾病高危人次"></el-table-column>
      <el-table-column prop="cerebralApoplexy1" align="center" label="脑卒中疾病高危占比"></el-table-column>
      <el-table-column prop="cerebralApoplexyTotal2" align="center" label="脑卒中疾病中危人次"></el-table-column>
      <el-table-column prop="cerebralApoplexy2" align="center" label="脑卒中疾病中危占比"></el-table-column>
      <el-table-column prop="cerebralApoplexyTotal3" align="center" label="脑卒中疾病非常高危人次"></el-table-column>
      <el-table-column prop="cerebralApoplexy3" align="center" label="脑卒中疾病非常高危占比"></el-table-column>
      <el-table-column prop="cardiovascularTotal0" align="center" label="心血管疾病低风险人次"></el-table-column>
      <el-table-column prop="cardiovascular0" align="center" label="心血管疾病低风险占比"></el-table-column>
      <el-table-column prop="cardiovascularTotal1" align="center" label="心血管疾病非常高危人次"></el-table-column>
      <el-table-column prop="cardiovascular1" align="center" label="心血管疾病非常高危占比"></el-table-column>
    </el-table>
  </div>
</template>
<script>
