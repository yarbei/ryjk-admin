    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <ve-pie :data="leaveHospitalData" :settings="chartSettings" v-if="flag1 == true"></ve-pie>
          <el-table
            :border="true"
    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <ve-pie :data="reminderRevisit" :settings="chartSettings" v-if="flag3 == true"></ve-pie>
          <el-table
            :border="true"
      ...
      <el-col :span="12">
        <el-card class="box-card">
          ...
          <ve-pie :data="appointmentRevisit" :settings="chartSettings" v-if="flag4 == true"></ve-pie>
          <el-table
            :border="true"
  ...
  methods: {
    ...
    getleaveHospitalData() {
      if(this.$store.state.user.user.type == 1 || this.$store.state.user.user.type  ==4){
        ...
        this.$store.state.user.user.id = this.$store.state.user.user.id;
      }
      this.$http(
        "/api" +
    ...
    leaveHospitalExport() {
      this.$http({
        url:
          "/api" +
          "/excel/exportDischarge?startTime=" +
          this.leaveHospitalDate[0] +
          "&endTime=" +
          this.leaveHospitalDate[1]+
          "&userId=" +
    ...
    administrationExport() {
      this.$http({
        url:
          "/api" +
          "/excel/exportAssessment?startTime=" +
          this.administrationDate[0] +
          "&endTime=" +
          this.administrationDate[1]+
          "&userId=" +
    ...
    reminderRevisitExport() {
      this.$http({
        url:
          "/api" +
          "/excel/exportReminderRevisit?startTime=" +
          this.reminderRevisitDate[0] +
          "&endTime=" +
          this.reminderRevisitDate[1]+
          "&userId=" +
    ...
    appointmentRevisitExport() {
      this.$http({
        url:
          "/api" +
          "/excel/exportAppointmentRevisit?startTime=" +
          this.appointmentRevisitDate[0] +
          "&endTime=" +
          this.appointmentRevisitDate[1]+
          "&userId=" +
