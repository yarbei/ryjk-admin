<template>
  <section class="table_container">
        ...
        <el-form-item class="f-left search_input">
          <el-input v-model="filters.name" placeholder="患者姓名">
            <template slot="append" icon="el-icon-search">
              <el-button type="primary" v-on:click="getEwList" style="background-color: #52d7ac; border-radius: 0; color: #fff; border: 1px solid #52d7ac"><i class="el-icon-search" style="margin-right: 5px"></i>搜索</el-button>
            </template>
          </el-input>
        </el-form-item>
      </el-form>
    ...
    <!--列表-->
    <el-table :data="ewArray" :border="true" stripe highlight-current-row v-loading="listLoading" style="width: 100%;">
      <el-table-column prop="content" align="center" label="提醒信息" sortable>
      </el-table-column>
      <el-table-column prop="doctor" align="center" label="执行人员" sortable>
      </el-table-column>
    ...
    <!--工具条-->
    <el-col :span="24" class="toolbar toolbar_page" v-if="ewArray.length>10">
      <el-pagination
